...
parser.add_argument('--num_channels', type=list, default=[20,15,10])
...
model = GREEN(n_txpcnn=args.n_txpcnn, n_stgcnn=args.n_stgcnn, output_feat=args.output_size, seq_len=args.obs_seq_len,
